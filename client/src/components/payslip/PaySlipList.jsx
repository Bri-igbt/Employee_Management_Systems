                                    ...
                                    <tr key={payslip._id || payslip.id}>
                                        ...
                                        <td className='text-center'>
                                            <button 
                                                ...
                                                className='inline-flex items-center px-3 py-1.5 text-xs font-medium rounded text-orange-600 bg-orange-50 hover:bg-orange-100 transition-colors ring-1 ring-orange-600/10'>
