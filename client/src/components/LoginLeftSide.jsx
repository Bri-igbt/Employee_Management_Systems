...
const LoginLeftSide = () => {
    return (
        <div className='hidden md:flex w-1/2 bg-orange-900 relative overfolw-hidden border-r border-slate-200'>
            <div className='absolute -top-30 -left-30 w-72 h-72 bg-orange-300/20 rounded-full blur-3xl'></div>
