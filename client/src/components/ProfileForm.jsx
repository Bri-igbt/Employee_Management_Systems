        ...
        <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
            ...
            <div className='space-y-5'>
                ...
                <div>
                    ...
                    />
                    <p className='text-xs text-slate-400 mt-1.5'>This will be display on your profile</p>
                </div>

                {initialData.isDeleted ? (
                    <div className='pt-2'>
                        <div className='p-4 bg-rose-50 border border-rose-200 rounded-xl text-center'>
                            <p className='text-rose-600 tracking-tight font-medium'>Account Deactivated</p>
